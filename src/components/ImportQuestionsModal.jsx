                ...
                {isValid && (
                  <div className="p-3 rounded-xl bg-secondary-container/50 border border-secondary/30 text-on-secondary-container text-xs flex items-center gap-2 font-label-md font-bold">
                    ...
                    <button
                      ...
                      className="ml-auto px-4 py-1.5 rounded-full bg-primary text-on-primary text-xs font-label-md hover:bg-primary-container transition-all press-effect"
                    >
                      Next: Choose Bank
                    </button>
                  </div>
          ...
          <div className="flex gap-3">
            ...
            {step === 'bank' && (
              <button
                ...
                className="px-5 py-2.5 rounded-full font-label-md text-sm bg-primary text-on-primary hover:bg-primary-container transition-all shadow-sm flex items-center gap-2 press-effect disabled:opacity-50 disabled:pointer-events-none"
              >
                {importing && <span className="w-3.5 h-3.5 border-2 border-current border-t-transparent rounded-full animate-spin" />}
